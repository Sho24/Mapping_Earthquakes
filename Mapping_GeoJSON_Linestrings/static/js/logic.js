...
// Alternative option for above setView Method for Multiple tile layer as below (// Create the map object with a center and zoom level.)
// let map = L.map("mapid", {
//    center: [
//      40.7, -94.5
//    ],
...
let torontoData  = "https://raw.githubusercontent.com/Sho24/Mapping_Earthquakes/main/torontoRoutes.json";
...
// Creating a GeoJSON layer with the retrieved data.
  L.geoJson(data,     
    {style: myStyle,    
    onEachFeature: function(feature, layer){
        layer.bindPopup("<h2> Airline Code: " + feature.properties.airline + "</h2>\n\n<h4>Airline Destination: " + feature.properties.dst + "</h4>\n\n<h5>Airline Source:" + feature.properties.src + "</h5>" );
    }    
  }).addTo(map);
});
